...
<head>
    ...
    <title>Сотрудники / DBB Финансы / Бухгалтерия в твоём кармане</title>
...
<div id="root">
    ...
    <main class="container">
        <h1 class="dashboard-h1">Сотрудники</h1>
        <section class="dashboard-wrapper d-flex flex-row">
            <aside class="dashboard-sidebar d-flex flex-column">
                ...
                <a href="{{ URL::to('coworker') }}" class="dashboard-selection dashboard-selection-active">Сотрудники</a>
            ...
            <article class="dashboard-content">
                <div class="dashboard-buttons d-flex flex-row">
                    <a href="{{ URL::to('coworker/add') }}" class="btn btn-primary m-1">Добавить сотрудника</a>
                </div>

                <div class="d-flex flex-column mt-3">
                    @foreach($coworker as $coworker)
